...
<div style="text-align: center; padding: 12px; color: #555555; font-size: 0.88rem;">
    ...
    <p style="margin: 4px 0 0 0;">
        Designed & Developed by <b>Charity Nduati</b> | Machine Learning Data Scientist | Credit Risk & Portfolio Analytics | Predictive Modeling
    </p>
    <p style="margin: 4px 0 0 0; font-size: 0.78rem; opacity: 0.8;">
        Keysian Auctioneers &bull; Nairobi, Kenya
    </p>
</div>
""", unsafe_allow_html=True)
